namespace ShareMyDay.Story.StoryFunctions
{
    public class StoryGeneration
    {
        ...
        public void Create()
        {
            ...
            //get all events from todays date
            ...
            //check the time of the events
            //if type of event is class or activity and the value is the same in multiple events within the same hour i.e how long a school period lasts then only take one 
